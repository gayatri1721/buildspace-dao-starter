...
const App = () => {
  ...
  console.log("👋 Address:", address);
   ...
   const editionDropAddress = "0xA1eCE25228D42224C886f7701AF6b3621bc0678d"
   const { contract: editionDrop } = useContract(editionDropAddress, "edition-drop");
   // Initialize our token contract
const { contract: token } = useContract('0xD6599d90E342c4c3A7bD776cDb2f12E3402deD4B', 'token');
const { contract: vote } = useContract("0xe6Fe150a455203481640D0116DD3DF8d59D79DD7", "vote");
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Welcome to GovernanceDAO</h1>
